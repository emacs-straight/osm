...
Please take a look at the [[https://wiki.openstreetmap.org/wiki/Raster_tile_providers][OpenStreetMap Wiki]] and the [[https://github.com/minad/osm/wiki][Osm.el Wiki]] for additional
tile server configurations, e.g., Google Maps for satellite and aerial maps.
...
the ~browse-url-default-handlers~ list. This way you can open these links directly
